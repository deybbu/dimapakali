...
// Now Showing (movies marked as now_showing OR with schedules >= today, but NOT coming_soon)
// coming_soon flag takes priority - if TRUE, movie will NOT appear in Now Showing
if ($has_now_showing) {
...
// If no movies with schedules found, show movies marked as now_showing (excluding coming_soon)
...
// Final fallback: show all movies EXCEPT coming_soon if still empty (for admin panel)
if (empty($nowShowing)) {
    if ($has_now_showing) {
...
$activeMovies = count($nowShowing); // safe even if $nowShowing is empty

// Coming Soon (movies marked as coming_soon OR with schedules > today, but NOT now_showing)
if ($has_now_showing) {
...
// Fallback: if no coming soon movies found and column exists, show movies marked as coming_soon
                            ...
                            <div class="movie-overlay">
                                <div class="movie-info">
                                    ...
                                    <div class="movie-actions">
                                        ...
                                        <a href="view-shows.php" class="action-btn ticket-btn" style="text-decoration: none; display: inline-block;">🎟 View Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
