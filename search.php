...
if (!empty($search_query)) {
    ...
    // Fixed: Check if movie has ANY show_date >= CURDATE() to determine if it's "now showing"
    $movie_sql = "
    SELECT 
        m.movie_show_id,
        m.title,
                        ...
                        <div class="search-result-card">
                            ...
                            <div class="search-result-content">
                                ...
                                <?php if ($result['status'] === 'now-showing'): ?>
                                    <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in']): ?>
                                        <button class="btn ticket-btn" onclick="window.location.href='seat-reservation.php'">Book Tickets</button>
                                    <?php else: ?>
                                        <button class="btn ticket-btn" onclick="window.location.href='login.php'">Login to Book Tickets</button>
                                    <?php endif; ?>
                                <?php else: ?>
